...
export const metadata: Metadata = {
  title: "Über BELLA & R. Schwertfechter | welches-hundefutter.today",
  description: "R. Schwertfechter, Gründer von BELLA: KI-Berater für Handyverträge trotz Schufa. Mission, Expertise und Hintergrund.",
      ...
      <main className="flex-1 max-w-4xl mx-auto px-5 py-14 w-full">
        ...
        <div className="bg-gray-900 rounded-2xl p-6 mb-10 flex items-start gap-5">
          ...
          <div>
            ...
            <p className="text-indigo-400 text-sm mb-2">Gründer & KI-Berater, BELLA Intelligence System</p>
            <p className="text-gray-400 text-sm leading-relaxed">
              R. Schwertfechter ist Gründer von BELLA und spezialisiert auf KI-gestützte Beratung im
            ...
            <div className="flex gap-3 mt-3 text-xs text-gray-500">
              ...
              <span>·</span>
              <a href="mailto:support@welches-hundefutter.today" className="text-indigo-400 hover:text-indigo-300">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-xl text-white/55 max-w-2xl mx-auto leading-relaxed">
            BELLA ist Deutschlands erster KI-Berater, der basierend auf deiner Schufa-Situation den
            passenden Hundeernährung findet – in unter 60 Sekunden.
          </p>
        </div>
        ...
        <section className="mb-14">
          ...
          <div className="bg-white/[0.04] rounded-2xl p-6 space-y-4 text-white/70 leading-relaxed">
            ...
            <p>
              welches-hundefutter.today wurde aus der Überzeugung heraus gebaut, dass ein guter Berater — einer, der wirklich zuhört — dieses Problem lösen kann. Kein Scrollen durch Listen. Kein Verwirrspiel mit Kleinstdrucktext. Stattdessen: ein Gespräch.
            </p>
            <p>
              BELLA ist das Ergebnis. Ein KI-Berater, der aus über 6.000 tagesaktuellen echten Angeboten die 3 besten für dich heraussucht — basierend auf dem, was du ihm sagst.
            </p>
          </div>
        </section>
        ...
        <section className="mb-14">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {[
              { icon: "🎯", title: "Beraten statt listen", body: "BELLA trifft Entscheidungen. Er empfiehlt 3 Angebote — nicht 300. Weil weniger Auswahl bessere Entscheidungen produziert." },
              { icon: "🔒", title: "Unabhängig & neutral", body: "Provision beeinflusst keine Empfehlung. BELLAs Empfehlungen basieren auf Nutzerprofil, Preis-Leistung und Netzqualität." },
        ...
        <section className="bg-gradient-to-r from-indigo-600/20 to-violet-600/20 border border-indigo-500/30 rounded-2xl p-6 text-center">
          ...
          <a href="mailto:support@welches-hundefutter.today" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-indigo-500 to-violet-600 font-semibold hover:shadow-lg hover:shadow-indigo-500/30 transition-all text-sm">
            support@welches-hundefutter.today →
          </a>
