...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const statisch: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/gutscheine`, lastModified: now, changeFrequency: 'weekly', priority: 0.8 },
    { url: `${BASE}/widget`, lastModified: now, changeFrequency: 'monthly', priority: 0.75 },
    { url: `${BASE}/hundefutter-online-kaufen`, lastModified: now, changeFrequency: 'daily', priority: 0.85 },
    { url: `${BASE}/hundefutter-abo`, lastModified: now, changeFrequency: 'monthly', priority: 0.75 },
    { url: `${BASE}/probierpakete-hundefutter`, lastModified: now, changeFrequency: 'weekly', priority: 0.75 },
    { url: `${BASE}/hochwertiges-hundefutter`, lastModified: now, changeFrequency: 'weekly', priority: 0.8 },
