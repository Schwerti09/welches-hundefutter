...
const koelnOffers = [
  ...
  },
  {
    ...
    affiliateNetwork: "AWIN",
    trackingId: "awin-koeln-12355",
    bonus: "🎁 Gratis Zubehör",
    rating: 4.7,
    inStock: true,
  },
  {
...
export const metadata = {
  title: "Köln - Handy mit Vertrag | Top Angebote | handytrotzschufa.today",
  description:
  ...
  alternates: {
    canonical: "https://handytrotzschufa.today/koeln",
  },
};
...
export default function KoelnPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50">
      {/* Hero Section */}
      <header className="relative bg-gradient-to-r from-purple-700 via-violet-600 to-purple-800 text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-20">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="#angebote"
                className="px-8 py-4 bg-white text-purple-700 rounded-xl font-bold text-lg hover:bg-purple-50 transition-all shadow-xl hover:shadow-2xl transform hover:-translate-y-1"
              >
                Jetzt vergleichen
              </a>
              <a
                href="/#advisor"
                className="px-8 py-4 bg-purple-900 text-white rounded-xl font-bold text-lg hover:bg-purple-950 transition-all shadow-xl border-2 border-white/30 hover:-translate-y-1"
              >
                🤖 AI Advisor starten
              </a>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
            ...
            <div className="text-gray-600 text-sm">Stores in Köln</div>
          </div>
          <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
      ...
      <section className="max-w-7xl mx-auto px-4 py-12">
        <div className="bg-gradient-to-r from-purple-700 to-violet-700 rounded-3xl p-8 md:p-12 text-white shadow-2xl">
