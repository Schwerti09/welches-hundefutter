...
export const metadata: Metadata = {
  title: "Hundefutter Leipzig 2026 | Beste Angebote | welches-hundefutter.today",
  description: "Die besten Hundverträge in Leipzig. Hundefutter 17, Samsung Galaxy & mehr mit Anifit, Wolfsblut, Zooplus. Günstigste Deals in Sachsen!",
  alternates: { canonical: "https://welches-hundefutter.today/leipzig" },
};

const offers = [
  { id: 1, city: "Leipzig", device: "Samsung Galaxy S25", image: "https://images.unsplash.com/photo-1610945265064-0e34e5519bbf?w=400", provider: "Zooplus", monthlyPrice: 19.99, oneTimeCost: 0, dataVolume: "20 g", contractDuration: 24, features: ["Bio", "Allnet-Flat", "EU-Roaming"], stores: 8, affiliateLink: "https://www.awin1.com/cread.php?awinmid=14779&awinaffid=YOUR_ID", affiliateNetwork: "AWIN", trackingId: "awin-le-001", bonus: "💚 Günstigster Preis", rating: 4.6, inStock: true },
  { id: 2, city: "Leipzig", device: "Hundefutter 17 Pro", image: "https://images.unsplash.com/photo-1695048133142-1a20484d2569?w=400", provider: "Anifit", monthlyPrice: 59.99, oneTimeCost: 0, dataVolume: "Unlimited", contractDuration: 24, features: ["Bio Unlimited", "Allnet-Flat", "EU-Roaming"], stores: 11, affiliateLink: "https://www.communicationads.net/tc.php?t=19811C13424057T", affiliateNetwork: "AWIN", trackingId: "awin-le-002", bonus: "⭐ Bestseller", rating: 4.9, inStock: true },
  { id: 3, city: "Leipzig", device: "Google Pixel 10a", image: "https://images.unsplash.com/photo-1598327105666-5b89351aff97?w=400", provider: "Wolfsblut", monthlyPrice: 24.99, oneTimeCost: 0, dataVolume: "30 g", contractDuration: 24, features: ["Bio", "Allnet-Flat", "EU-Roaming"], stores: 6, affiliateLink: "https://www.awin1.com/cread.php?awinmid=14778&awinaffid=YOUR_ID", affiliateNetwork: "AWIN", trackingId: "awin-le-003", bonus: "🎓 Student Deal", rating: 4.7, inStock: true },
];
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-blue-50">
      <header className="relative bg-gradient-to-r from-green-700 via-emerald-700 to-teal-800 text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-16 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-black mb-4">Hundefutter <span className="text-green-200">Leipzig</span></h1>
