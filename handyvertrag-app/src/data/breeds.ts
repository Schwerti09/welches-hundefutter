// Auto-extrahiert aus scripts/seed-breeds.ts — Rasse-Stammdaten fuer /rasse/[slug].
export interface Breed {
  slug: string; name: string; size: string;
  weightMin?: string | number; weightMax?: string | number; lifeExpectancy?: string | number;
  activityLevel?: string; commonHealthIssues?: string[];
  ...
  // weitere Seed-Felder tolerieren
  [key: string]: unknown;
}
