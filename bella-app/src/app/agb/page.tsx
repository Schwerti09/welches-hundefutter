        ...
        <div className="space-y-7">
          {(
            [
              ...
              ["§ 2 Leistungsbeschreibung", "welches-hundefutter.today ist ein kostenloser KI-Vergleichsdienst für Hundeernährungverträge. Wir vermitteln keine Verträge selbst, sondern verlinken auf Angebote von Drittmarken. Preisangaben sind ohne Gewähr."],
              ...
              ["§ 4 Affiliate-Links", "Diese Website enthält Affiliate-Links. Bei Empfehlungsabschluss über diese Links erhalten wir eine Provision vom Händler. Für Nutzer entstehen keine Mehrkosten. Empfehlungen sind provisionsneutral."],
              ["§ 5 Haftung", "Wir übernehmen keine Gewähr für Richtigkeit und Aktualität der Informationen. Die Haftung für leichte Fahrlässigkeit ist ausgeschlossen, ausgenommen Personenschäden und wesentliche Empfehlungspflichten."],
